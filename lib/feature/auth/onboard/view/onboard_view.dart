...
class _OnBoardViewState extends State<OnBoardView>
            ...
            Scaffold(
                ...
                body: Observer(
                    builder: (_) => Column(children: [
                          ...
                          Expanded(
                              flex: 1, child: buildTabIndicator(viewModel)),
                          Expanded(
                              flex: 1, child: buildFooter(viewModel, context))
                        ]))));
  }

  TabIndicator buildTabIndicator(OnBoardViewModel viewModel) => TabIndicator(
      selectedIndex: viewModel.currentIndex,
      itemLength: viewModel.onBoardItems.length);
  ...
  Widget buildFooter(OnBoardViewModel viewModel, BuildContext context) =>
      SizedBox.expand(
          child: TitleTextButton(
              onPressed: viewModel.completeToOnBoard,
              child: Text(LocaleKeys.onBoard_getStarted.tr())));
  ...
  Widget buildAutoLocalTextDescription(
