...
abstract class _OnBoardViewModelBase with Store, BaseViewModel {
  ...
  TextEditingController? favoriteDriverTextFieldController;
  ...
  void init() {
    ...
    favoriteDriverTextFieldController = TextEditingController();
  ...
  void incrementSelectedPage([int? value]) =>
      value != null ? currentIndex = value : currentIndex++;
  ...
  Future<void> saveCache() async {
    appCacheModel = const AppCacheModel().copyWith(
        ...
        isFirstInit: false,
        favoriteDriver: favoriteDriverTextFieldController!.text);
  ...
  void completeToOnBoard() =>
      navigation.router.go(NavigationEnums.onBoardSubView.routeName);
}
