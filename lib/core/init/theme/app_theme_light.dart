...
import 'light/light_theme_mixin.dart';

class AppThemeLight extends AppTheme with LightThemeMixin {
  ...
  TextButtonThemeData get textButtonTheme => TextButtonThemeData(
      style: TextButton.styleFrom(
          ...
          disabledForegroundColor: colorSchemeLight!.white.withOpacity(0.38),
  ...
  ElevatedButtonThemeData get elevatedButtonTheme => ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
          ...
          disabledForegroundColor: colorSchemeLight!.black.withOpacity(0.38),
          disabledBackgroundColor: colorSchemeLight!.black.withOpacity(0.12),
          shadowColor: colorSchemeLight!.black,
  ...
  InputDecorationTheme get inputTheme => InputDecorationTheme(
      ...
      errorBorder: UnderlineInputBorder(
          borderSide: BorderSide(
              color: colorSchemeLight!.red, width: 2, style: BorderStyle.solid),
          borderRadius: const BorderRadius.all(Radius.circular(4.0))),
      focusedBorder: UnderlineInputBorder(
          borderSide: BorderSide(
              color: colorSchemeLight!.purple,
              width: 2,
              style: BorderStyle.solid),
          borderRadius: const BorderRadius.all(Radius.circular(4.0))),
  ...
  TabBarTheme get tabBarTheme => TabBarTheme(
      ...
      indicator: UnderlineTabIndicator(
          borderSide: BorderSide(color: _appColorScheme.primary, width: 2)));
}
